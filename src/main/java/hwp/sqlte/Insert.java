...
public class Insert {
    ...
    public Insert handleResult(Consumer<ResultSet> rs) {
...
/*
    public void asyncExecute(Consumer<ResultSet> consumer) throws SQLException {
...
/*            int batchSize = 1000;
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Insert insert = new Insert(standardSql, null);
        User user = new User();
